...
class Project(models.Model) :
    owner = models.ForeignKey(PassionUser, on_delete=models.CASCADE, related_name='pitched_projects', default=PassionUser.objects.get(username="kanika127@gmcil.com")) ## will delete project when user is deleted
