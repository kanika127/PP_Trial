...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='project',
            name='sample_wrk',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='sample_work', to='app1.samplewrktbl'),
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
        ...
        migrations.AddField(
            model_name='project',
            name='owner',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='pitched_projects', to='app1.passionuser'),
        ),
        migrations.CreateModel(
            name='Application',
            fields=[
