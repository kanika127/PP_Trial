...
class Application(models.Model):
    ...
    ques_1_content = models.ForeignKey(ApplicationQuestions, on_delete=models.CASCADE, related_name='application_content_1', null=True, default=None)
    ques_2_content = models.ForeignKey(ApplicationQuestions, on_delete=models.CASCADE, related_name='application_content_2', null=True, default=None)
    ques_3_content = models.ForeignKey(ApplicationQuestions, on_delete=models.CASCADE, related_name='application_content_3', null=True, default=None)
